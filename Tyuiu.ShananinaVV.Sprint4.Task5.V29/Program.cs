...
using Tyuiu.ShananinaVV.Sprint4.Task5.V29.Lib;

namespace Tyuiu.ShananinaVV.Sprint4.Task5.V29
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* случайными значениями в диапазоне от -9 до 9.                           *");
